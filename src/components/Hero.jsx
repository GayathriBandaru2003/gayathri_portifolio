  ...
  return (
    <section className="w-full relative z-10 overflow-x-hidden flex flex-col items-center md:flex md:flex-row justify-between py-8 mx-auto text-white border-white border-0">
        <div className="w-full md:w-1/2 flex flex-col gap-y-7 items-center md:items-start contai justify-center py-8 px-8 mx-10 md:mx-0 lg:mx-6 border-white border-0">
            <h1 className="bg-gradient-to-r from-pink-700 to-red-400 text-transparent bg-clip-text text-4xl md:text-3xl xl:text-4xl 2xl:text-5xl font-semibold">
                Hey, I am Anurag Verma
            </h1>
            ...
            <nav className="flex gap-x-3 mt-2 justify-center">
                <a className="rounded-full hover:scale-110 transition justify-center items-center flex gap-x-2 py-2 px-3" href="https://www.linkedin.com/in/anurag-verma-78698a18b/" target="_blank" rel="noopener"> 
                    <span className="text-white text-2xl"><FaLinkedin /></span>
                    LinkedIn
                </a>
                
                <a className="rounded-full hover:scale-110 transition justify-center items-center flex gap-x-2 py-2 px-3" href="https://github.com/Anurag-verma18" target="_blank" rel="noopener"> 
                    <span className="text-white text-2xl"><FaGithub /></span>
                    Github
                </a>

                <a className="rounded-full hover:scale-110 transition justify-center items-center flex gap-x-2 py-2 px-3" href="https://x.com/Anurag__V" target="_blank" rel="noopener"> 
                    <span className="text-white text-2xl"><FaSquareXTwitter /></span>
                    Twitter
                </a>
            </nav>
